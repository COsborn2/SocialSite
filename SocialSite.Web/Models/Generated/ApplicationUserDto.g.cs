...
{
    public partial class ApplicationUserDtoGen : GeneratedDto<SocialSite.Data.Models.ApplicationUser>
    {
        ...
        /// </summary>
        public override void MapFrom(SocialSite.Data.Models.ApplicationUser obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(SocialSite.Data.Models.ApplicationUser entity, IMappingContext context)
        {
            var includes = context.Includes;
